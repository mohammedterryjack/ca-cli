...
def gpt():
    ...
    click.secho("Train your own character-level GPT model (with just a CPU).\n", fg="magenta")
...
@click.option("--vocab", "-v", type=str, default=(
...
@click.option("--output-dir", "-o", type=Path, required=True,
