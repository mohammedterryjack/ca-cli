...
from tools.utils import (
    load_model, generate_text, evolution_to_parquet_string,
    safe_string_to_evolution, save_evolutions_as_parquet, EOL
)
import traceback
...
class FFNNPredictView(Screen):
    ...
    def compose(self):
        ...
        with Horizontal():
            ...
            with Vertical():
                ...
                yield Input(id="learn_mode", value="generative", placeholder="generative")
    ...
    def start_prediction(self):
        ...
        if learn_mode != "generative":
            output_box.update(f"[red]Only 'generative' mode supported for prediction[/red]")
            return
        ...
        try:
            ...
            output_box.update(f"[red]Error during prediction:[/red]\n{e}\n\n[grey]{tb}[/grey]")
